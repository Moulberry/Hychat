...
public class ColourWheel extends GuiElement {

    public static final ResourceLocation colour_selector_dot = new ResourceLocation("hychat:core/colour_selector_dot.png");
    public static final ResourceLocation colour_selector_bar = new ResourceLocation("hychat:core/colour_selector_bar.png");
    public static final ResourceLocation colour_selector_bar_alpha = new ResourceLocation("hychat:core/colour_selector_bar_alpha.png");
    public static final ResourceLocation colour_selector_chroma = new ResourceLocation("hychat:core/colour_selector_chroma.png");
    ...
    public ColourWheel(int x, int y, String initialColour, Consumer<String> colourChangedCallback,
